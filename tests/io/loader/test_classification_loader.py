...
from fastNLP.io.loader.classification import (
    ChnSentiCorpLoader, IMDBLoader, MRLoader, NG20Loader, OhsumedLoader,
    R8Loader, R52Loader, SST2Loader, SSTLoader, THUCNewsLoader,
    WeiboSenti100kLoader, YelpFullLoader, YelpPolarityLoader)
...
class TestDownload:
    ...
    def test_download(self):
        for loader in [
                YelpFullLoader, YelpPolarityLoader, IMDBLoader, SST2Loader,
                SSTLoader, ChnSentiCorpLoader
        ]:
            loader().download()
...
class TestLoad:
    ...
    def test_process_from_file(self):
        data_set_dict = {
            'yelp.p': ('data_for_tests/io/yelp_review_polarity',
                       YelpPolarityLoader, (6, 6, 6), False),
            'yelp.f': ('data_for_tests/io/yelp_review_full', YelpFullLoader,
                       (6, 6, 6), False),
            ...
            'ChnSentiCorp': ('data_for_tests/io/ChnSentiCorp',
                             ChnSentiCorpLoader, (6, 6, 6), False),
            'THUCNews':
            ('data_for_tests/io/THUCNews', THUCNewsLoader, (9, 9, 9), False),
            'WeiboSenti100k': ('data_for_tests/io/WeiboSenti100k',
                               WeiboSenti100kLoader, (6, 7, 6), False),
            ...
            'ohsumed':
            ('data_for_tests/io/R52', OhsumedLoader, (6, 6, 6), False),
