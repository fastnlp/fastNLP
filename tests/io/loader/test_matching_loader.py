...
from fastNLP.io.loader.matching import (BQCorpusLoader, CNXNLILoader,
                                        LCQMCLoader, MNLILoader, QNLILoader,
                                        QuoraLoader, RTELoader, SNLILoader)
...
class TestMatchingLoad:
    ...
    def test_load(self):
        data_set_dict = {
            ...
            'MNLI':
            ('data_for_tests/io/MNLI', MNLILoader, (5, 5, 5, 5, 6), True),
            'Quora':
            ('data_for_tests/io/Quora', QuoraLoader, (2, 2, 2), False),
            'BQCorpus':
            ('data_for_tests/io/BQCorpus', BQCorpusLoader, (5, 5, 5), False),
            'XNLI': ('data_for_tests/io/XNLI', CNXNLILoader, (6, 6, 8), False),
            'LCQMC':
            ('data_for_tests/io/LCQMC', LCQMCLoader, (6, 5, 6), False),
        }
