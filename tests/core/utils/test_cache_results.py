...
class TestCacheResults:
    ...
    def test_refer_fun_change(self):
        ...
        try:
            cmd = f'python {__file__} --cache_fp {cache_fp} ' + \
                  f'--test_type {test_type} --turn 0'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--test_type', type=str, default='refer_class_method_change')
