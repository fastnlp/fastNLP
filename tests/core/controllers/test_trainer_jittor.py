...
from fastNLP.core.controllers.trainer import Evaluator, Trainer
...
class JittorNormalModel_Classification(Module):
    ...
    def __init__(self, num_labels, feature_dimension):
        ...
        self.linear1 = nn.Linear(
            in_features=feature_dimension, out_features=64)
        self.ac1 = nn.ReLU()
...
def test_trainer_jittor(
    ...
    train_dataloader = JittorDataLoader(
        dataset=JittorRandomMaxDataset(20,
                                       TrainJittorConfig.feature_dimension),
        batch_size=TrainJittorConfig.batch_size,
        shuffle=True,
        # num_workers=4,
    )
    val_dataloader = JittorDataLoader(
        dataset=JittorRandomMaxDataset(12,
                                       TrainJittorConfig.feature_dimension),
        batch_size=TrainJittorConfig.batch_size,
        shuffle=True,
        # num_workers=4,
