...
from fastNLP.core.dataloaders.jittor_dataloader import (
    JittorDataLoader, prepare_jittor_dataloader)
...
class TestJittor:
    ...
    def test_huggingface_datasets(self):
        ...
        jtl = JittorDataLoader(
            dataset, batch_size=4, drop_last=True, shuffle=False)
        for batch in jtl:
