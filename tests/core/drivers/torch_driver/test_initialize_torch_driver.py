...
from fastNLP.core.drivers import TorchDDPDriver, TorchSingleDriver
...
def test_incorrect_driver():
    ...
    with pytest.raises(ValueError):
        initialize_torch_driver('paddle', 0, model)


@pytest.mark.torch
@pytest.mark.parametrize('device', ['cpu', 'cuda:0', 0, torchdevice('cuda:0')])
@pytest.mark.parametrize('driver', ['torch'])
