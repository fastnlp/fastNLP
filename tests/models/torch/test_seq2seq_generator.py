...
from fastNLP import (Accuracy, Callback, DataSet, TorchDataLoader, Trainer,
                     Vocabulary)
...
class TestSeq2SeqGeneratorModel:
    ...
    def test_run(self):
        ...
        model1 = TransformerSeq2SeqModel.build_model(
            src_embed=embed,
            tgt_embed=None,
            pos_embed='sin',
            max_position=20,
        ...
        trainer = Trainer(
            ...
            evaluate_input_mapping=lambda x: {
                'target': x['tgt_tokens'],
        ...
        embed, dl = prepare_env()
        model2 = LSTMSeq2SeqModel.build_model(
            src_embed=embed,
            tgt_embed=None,
            num_layers=1,
            hidden_size=20,
