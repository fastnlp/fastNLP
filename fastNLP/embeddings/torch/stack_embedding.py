...
class StackEmbedding(TokenEmbedding):
    ...
    def __init__(self,
        ...
        super(StackEmbedding, self).__init__(
            _vocab, word_dropout=word_dropout, dropout=dropout)
        assert isinstance(embeds, list)
        for embed in embeds:
            assert isinstance(
                embed,
                TokenEmbedding), 'Only TokenEmbedding type is supported.'
    ...
    def append(self, embed: TokenEmbedding):
        ...
        _check_vocab_has_same_index(self.get_word_vocab(),
                                    embed.get_word_vocab())
