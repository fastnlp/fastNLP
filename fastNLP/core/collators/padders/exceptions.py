__all__ = [
    'InconsistencyError', 'EleDtypeUnsupportedError',
    'EleDtypeDtypeConversionError', 'DtypeUnsupportedError', 'DtypeError',
    'NoProperPadderError'
]
...
class EleDtypeUnsupportedError(DtypeError):
    r"""当 batch 中的 element 的类别本身无法 pad 的时候报错。例如要求 str 类型的数
    据进行 padding 。"""
