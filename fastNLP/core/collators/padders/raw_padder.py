...
__all__ = ['RawNumberPadder', 'RawSequencePadder', 'RawTensorPadder']
...
class RawSequencePadder(Padder):
    ...
    def pad(batch_field, pad_val=0, dtype=None):
        ...
        return get_padded_numpy_array(
            batch_field, dtype=dtype, pad_val=pad_val).tolist()
...
class RawTensorPadder(Padder):
    ...
    def pad(batch_field, pad_val=0, dtype=None):
        ...
        try:
            ...
            raise RuntimeError('If the field is not a list or tuple '
