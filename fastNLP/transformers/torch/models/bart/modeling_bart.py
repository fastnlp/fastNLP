...
if _NEED_IMPORT_TORCH:
    ...
    from torch.nn import CrossEntropyLoss, Embedding, Module, MSELoss
else:
...
class BartDecoder(BartPretrainedModel):
    ...
    layer is a :class:`BartDecoderLayer`
...
class BartDecoderWrapper(BartPretrainedModel):
    ...
    checkpoints when the causal language model is used in combination with the
    :class:`~transformers.EncoderDecoderModel` framework."""
