# isort: skip_file
r"""
**Loader** 用于读取数据，并将内容读取到 :class:`~fastNLP.core.DataSet` 或者
...
2.传入一个文件夹目录
    将读取的是这个文件夹下文件名中包含 `train` , `test` , `dev` 的文件，其它文件会
    被忽略。假设某个目录下的文件为::
    ...
    ``data_bundle.get_dataset('test')`` 获取对应的 `dataset` ，其中 `other.txt`
    的内容会被忽略。假设某个目录下的文件为::
...
__all__ = [
    'Loader', 'CLSBaseLoader', 'YelpFullLoader', 'YelpPolarityLoader',
    'AGsNewsLoader', 'DBPediaLoader', 'IMDBLoader', 'SSTLoader', 'SST2Loader',
    'ChnSentiCorpLoader', 'THUCNewsLoader', 'WeiboSenti100kLoader', 'MRLoader',
    'R8Loader', 'R52Loader', 'OhsumedLoader', 'NG20Loader', 'ConllLoader',
    'Conll2003Loader', 'Conll2003NERLoader', 'OntoNotesNERLoader', 'CTBLoader',
    'MsraNERLoader', 'PeopleDailyNERLoader', 'WeiboNERLoader', 'CSVLoader',
    'JsonLoader', 'CWSLoader', 'MNLILoader', 'QuoraLoader', 'SNLILoader',
    'QNLILoader', 'RTELoader', 'CNXNLILoader', 'BQCorpusLoader', 'LCQMCLoader',
    'CMRC2018Loader'
]

from .classification import (CLSBaseLoader, YelpFullLoader, YelpPolarityLoader,
                             AGsNewsLoader, IMDBLoader, SSTLoader, SST2Loader,
                             DBPediaLoader, ChnSentiCorpLoader, THUCNewsLoader,
                             WeiboSenti100kLoader, MRLoader, R8Loader,
                             R52Loader, OhsumedLoader, NG20Loader)
from .conll import (ConllLoader, Conll2003Loader, Conll2003NERLoader,
                    OntoNotesNERLoader, CTBLoader)
from .conll import MsraNERLoader, PeopleDailyNERLoader, WeiboNERLoader
from .csv import CSVLoader
from .cws import CWSLoader
from .json import JsonLoader
from .loader import Loader
from .matching import (MNLILoader, QuoraLoader, SNLILoader, QNLILoader,
